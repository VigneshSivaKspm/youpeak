...
export const TASKER_TIERS = [
  ...
  {
    id: "silver",
    name: "Silver Tasker (Intermediate)",
    price: 2499,
    priceLabel: "₹2,499",
    period: "One-Time Pass",
    popular: true,
  ...
  {
    id: "platinum",
    name: "Platinum Tasker (Regional Pro)",
    price: 9999,
    priceLabel: "₹9,999",
    period: "One-Time Pass",
    popular: false,
  ...
  {
    id: "diamond",
    name: "Diamond Pass (Special Pass)",
    level: "Special Pass",
    price: 24999,
    priceLabel: "₹24,999",
    period: "Annual Pass",
